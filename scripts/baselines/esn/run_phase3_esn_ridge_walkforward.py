...
def make_esn_weights(
    ...
    """Backward-compatible wrapper for downstream historical scripts."""
...
def fit_ridge_scores(H, y, alpha):
    """Backward-compatible wrapper around the shared log-ridge readout."""
    return _fit_log_ridge_scores(H, y, alpha)
