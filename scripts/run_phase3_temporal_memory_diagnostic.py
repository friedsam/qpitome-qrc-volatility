...
def main() -> None:
    ...
    base = RydbergQRCConfig(
        ...
        lookback_days=K,
        anchor_count=K,       # anchors == lookback: every timestep injected
        anchor_policy="even",
        ...
        omega_mode="constant",  # Delta(t) is the ONLY input channel here
    )
    ...
    # Aggregates: cross-time capacity vs separation per variant.
    ...
    # Figure: cross-time capacity vs separation + class means.
