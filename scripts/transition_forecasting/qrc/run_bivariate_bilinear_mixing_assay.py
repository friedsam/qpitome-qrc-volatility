...
from transition_forecasting.qrc.bivariate_bilinear_mixing_assay import (
    ...
    run_bivariate_bilinear_mixing_assay,
)
...
DEFAULT_RESULTS_ROOT = Path(
    "results/transition_forecasting/qrc/run_bivariate_bilinear_mixing_assay"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Compare the balanced palindrome with order-reversed longitudinal/transverse "
            "schedules and test interaction-dependent bivariate mixing."
        )
    )
...
def main() -> None:
    ...
    run_dir = run_bivariate_bilinear_mixing_assay(
