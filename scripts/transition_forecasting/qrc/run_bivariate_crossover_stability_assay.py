...
from transition_forecasting.qrc.bivariate_crossover_stability_assay import (
    ...
    run_bivariate_crossover_stability_assay,
)
...
DEFAULT_RESULTS_ROOT = Path(
    "results/transition_forecasting/qrc/run_bivariate_crossover_stability_assay"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Test palindromic crossover stability on exchange-paired bivariate inputs "
            "using the hardware-natural occupation/pair readout bank."
        )
    )
...
def main() -> None:
    ...
    run_dir = run_bivariate_crossover_stability_assay(
