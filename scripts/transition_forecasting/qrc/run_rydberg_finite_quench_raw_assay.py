...
from transition_forecasting.qrc.rydberg_finite_quench_raw_assay import (
    run_rydberg_finite_quench_raw_assay,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "apply one finite positive detuning quench, and test raw "
            "post-quench reporter occupations as the predeclared L5 warning "
            "features under exact and finite-shot measurements."
        )
    )
...
def main() -> None:
    ...
    run_dir = run_rydberg_finite_quench_raw_assay(
