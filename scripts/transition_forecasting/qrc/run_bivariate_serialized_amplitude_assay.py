...
from transition_forecasting.qrc.bivariate_serialized_amplitude_assay import (
    ...
    run_bivariate_serialized_amplitude_assay,
)
...
DEFAULT_RESULTS_ROOT = Path(
    "results/transition_forecasting/qrc/run_bivariate_serialized_amplitude_assay"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Test single-channel temporal nonlinearity and serialize two features through "
            "the amplitude pathway."
        )
    )
...
def main() -> None:
    ...
    run_dir = run_bivariate_serialized_amplitude_assay(
