...
from transition_forecasting.qrc.rydberg_finite_quench_assay import (
    run_rydberg_finite_quench_assay,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "apply one finite positive detuning quench, and test whether "
            "raw post-quench reporter responses distinguish L5 transitions "
            "from matched controls under exact and finite-shot measurements."
        )
    )
...
def main() -> None:
    ...
    assay = FiniteQuenchAssayConfig(
        ...
        quench_delta_offset_rad_us=args.quench_delta_offset_rad_us,
    ...
    run_dir = run_rydberg_finite_quench_assay(
