...
from transition_forecasting.qrc.bivariate_crossover_interaction_assay import (
    ...
    run_bivariate_crossover_interaction_assay,
)
...
DEFAULT_RESULTS_ROOT = Path(
    "results/transition_forecasting/qrc/run_bivariate_crossover_interaction_assay"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Sweep interaction strength at the selected 0.02 us palindromic crossover "
            "duration and test balanced memory and permutation-significant mixing."
        )
    )
    ...
    parser.add_argument(
        ...
        type=float,
        nargs="+",
        default=[0.0, 0.25, 0.50, 0.75, 1.0, 1.25, 1.50, 2.0, 3.0],
    )
...
def main() -> None:
    ...
    run_dir = run_bivariate_crossover_interaction_assay(
