...
from transition_forecasting.qrc.bivariate_bilinear_duration_assay import (
    ...
    run_bivariate_bilinear_duration_assay,
)
...
DEFAULT_RESULTS_ROOT = Path(
    "results/transition_forecasting/qrc/run_bivariate_bilinear_duration_assay"
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=float,
        nargs="+",
        default=[0.01, 0.015, 0.02, 0.025, 0.03, 0.04],
    )
...
def main() -> None:
    ...
    run_dir = run_bivariate_bilinear_duration_assay(
