...
from transition_forecasting.qrc.ladder_readout_upgrade_assay import (
    run_ladder_readout_upgrade_assay,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Rerun only the frozen six-atom ladder core and compare global versus "
            "two-segment calibration and linear versus degree-two polynomial ridge."
        )
    )
...
def main() -> None:
    ...
    run_dir = run_ladder_readout_upgrade_assay(
