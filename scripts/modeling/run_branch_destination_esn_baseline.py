...
def main() -> None:
    ...
    parser.add_argument("--pathdir", type=Path, default=Path("/tmp/branch_destination_paths"))
    ...
    parser.add_argument("--outdir", type=Path, default=Path("/tmp/branch_destination_esn_baseline"))
