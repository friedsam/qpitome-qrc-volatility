...
V3 = Path(__file__).parents[1] / "baselines" / "run_long_history_har_residual_replication_v3.py"
spec = importlib.util.spec_from_file_location("long_v3", V3)
if spec is None or spec.loader is None:
    raise ImportError(V3)
...
def main() -> None:
    ...
    raw = v3.parse_yahoo_json(RAW_JSON)
